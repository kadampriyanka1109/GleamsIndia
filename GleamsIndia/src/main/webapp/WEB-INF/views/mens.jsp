		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="resources/images/men1.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="resources/images/men2.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="resources/images/men1.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="resources/images/men3.jpg" alt=" " />
				</div>
