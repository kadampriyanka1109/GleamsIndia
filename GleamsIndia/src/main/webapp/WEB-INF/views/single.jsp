				...
				<div class="flexslider">
					...
					<ul class="slides">
						...
						<li data-thumb="images/d4.jpg">
							<div class="thumb-image"> <img src="resources/images/d4.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
					</ul>
					<div class="clearfix"></div>
				</div>	
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="resources/images/men3.jpg" alt=" " class="img-responsive">
										</div>
