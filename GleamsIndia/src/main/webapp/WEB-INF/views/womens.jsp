			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item"><a class="menu__link" href="electronics">Electronics</a></li>
					<li class=" menu__item"><a class="menu__link" href="codes">Short Codes</a></li>
						...
						<ul>
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethinic Wear</label>
								<ul>
									...
									<li><a href="womens">Chudidars</a></li>
									<li><a href="womens">Wedges</a></li>
									<li><a href="womens">Tops</a></li>
									<li><a href="womens">Perfumes</a></li>
									<li><a href="womens">Caps</a></li>
								</ul>
							</li>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="resources/images/men21.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="resources/images/men11.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="resources/images/men21.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="resources/images/men31.jpg" alt=" " />
				</div>
				...
				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						...
						<div class="item-info-product ">
									<h4><a href="single">Hand Bag</a></h4>
									<div class="info-product-price">
										<span class="item_price">$45.99</span>
										<del>$69.71</del>
									</div>
